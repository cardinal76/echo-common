...
public class Hl7OutboundMessage  implements java.io.Serializable {
    ...
    public Hl7OutboundMessage(String messagecontrolid, String message, String status, String messagetype, Date sent) {
     ...
     @SequenceGenerator(name="it.clevercom.echo.rd.model.entity.Hl7OutboundMessageIdGenerator")@Id @GeneratedValue(strategy=SEQUENCE, generator="it.clevercom.echo.rd.model.entity.Hl7OutboundMessageIdGenerator")
