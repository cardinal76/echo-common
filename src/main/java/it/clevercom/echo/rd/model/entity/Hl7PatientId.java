...
public class Hl7PatientId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		return ((this.getIdhl7patient() == castOther.getIdhl7patient()) || (this.getIdhl7patient() != null
				&& castOther.getIdhl7patient() != null && this.getIdhl7patient().equals(castOther.getIdhl7patient())))
