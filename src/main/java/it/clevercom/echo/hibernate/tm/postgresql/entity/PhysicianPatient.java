 ...
 */
@Entity
@Table(name="tm_physician_patient"
)
public class PhysicianPatient  implements java.io.Serializable {
    ...
    public PhysicianPatient(PhysicianPatientId id, Patient patient, Physician physician, Date created, Date updated, boolean active, String updateuser) {
        this.id = id;
    ...
    public PhysicianPatient(PhysicianPatientId id, Patient patient, Physician physician, Boolean owner, Boolean subscriber, Date created, Date updated, boolean active, String updateuser) {
       this.id = id;
       this.patient = patient;
       this.physician = physician;
       this.owner = owner;
